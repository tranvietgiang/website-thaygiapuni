...
import { defaultContent, loadContent, saveContent } from './data/siteContent.js'
...
export default function App() {
  ...
  const currentContent = useMemo(() => content[lang] ?? content.vi, [content, lang])
  ...
  return (
    <div id="top" className="min-h-screen overflow-hidden bg-slate-50 text-slate-900">
      <Header
        content={currentContent}
        goToAdmin={() => setRoute('/admin')}
        lang={lang}
        setLang={setLang}
      />
      <main>
